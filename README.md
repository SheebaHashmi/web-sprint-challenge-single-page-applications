...
Ans:Validation is a method to check whether the user is providing the desired inputs or not. 

1. In 1-2 sentences, define end to end testing.

Ans: End to end testing is a way to check the entire application's behaviour, to make sure that it is according to the expectations/specification or not.
